        ...
        return `
            <div class="phrase-card">
                <div class="phrase-header">
                    <div class="phrase-text"><strong>${escapeHtml(phrase.displayPhrase)}</strong></div>
                ...
                <div class="phrase-translation">
                    <strong>Буквальный перевод:</strong> ${escapeHtml(phrase.displayTranslation)}
                </div>
                
                <div class="phrase-details">
                    <div class="detail-item">
                        <span class="detail-label">Семантика:</span>
                        ${escapeHtml(phrase.semantic_label || '—')}
                    </div>
                    
                    <div class="detail-item">
                        <span class="detail-label">Стилистика:</span>
                        ${escapeHtml(phrase.stylistic_label || '—')}
                    </div>
                ...
                ${phrase.commentary ? `
                    <div class="commentary">
                        <strong>Комментарий:</strong> ${escapeHtml(phrase.commentary)}
                    </div>
                    <hr />
                ` : ''}
            </div>
